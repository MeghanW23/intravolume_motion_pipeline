...
%% Get input data and configurations
...
sms_fac=4; %% if multiple slices are acquired at the same time, sms > 1
slice_timing = [ ...
        0, ...
		0.555, ...
		0.07, ...
...
thresh_forscrub = 0.6; % variable indicating volumes with framewise displacement > 0.5 will be marked for scrubbing

disp("rsfMRI_SMC_mc received the following inputs:")
...
disp("Motion Parameter Textfile:")
