...
### Pipeline Steps
1. [run_pipeline/submit_job.sh](https://github.com/MeghanW23/intravolume_motion_pipeline/blob/master/run_pipeline/submit_job.sh): Submits the job to slurm and runs the run_pipeline.py script. Takes in 1 or more config file(s).
