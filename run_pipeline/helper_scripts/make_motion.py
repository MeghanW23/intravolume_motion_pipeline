...
if __name__ == '__main__':
    """
    EXAMPLE USAGE:
        python run_pipeline/helper_scripts/make_motion.py \
            --nifti_image_path runs_and_data/participant_data/p005-ses-04-postrifg_func-bold_task-postRIFG_20250826105831_36.nii.gz \
            --json_file_path runs_and_data/participant_data/p005-ses-04-postrifg_func-bold_task-postRIFG_20250826105831_36.json \
            --working_directory_path runs_and_data/participant_runs/MOTION_INJECTED_FROM_ORIGINAL_IMAGE_p005-ses-04-postrifg_working/ \
            --output_directory_path runs_and_data/participant_runs/MOTION_INJECTED_FROM_ORIGINAL_IMAGE_p005-ses-04-postrifg_outputs/fake_motion_material/
    """
    ...
    parser.add_argument(
        ...
        required=False,
        help='Rotation parameters must be in RADIANS.'
    )
